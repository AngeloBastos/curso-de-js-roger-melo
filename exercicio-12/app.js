...
let messageMovies = 'Segundo o site Omelete, os melhores filmes de 2019 são:'
...
const youtubeUser = {
  ...
  getRecentVideos () {
    let listVideos = `Vídeos recentes de ${this.name}:`
    const recentVideosProperty = this.videos.recentVideos
    recentVideosProperty.forEach(video => {
      listVideos += `\n  ${video.title}`
    })
    return listVideos
  }
...
console.log(youtubeUser.getRecentVideos())
